...
users = [{:first_name => 'Joe', :last_name => "Biden",:type => "Doctor", :email => 'jbiden@example.com', :user_id => 123456, :phone_1 => '012-345-6789', :phone_2 => '333-333-3333', :phone_3 => '444-444-4444'},
        ...
        {:first_name => 'James', :last_name => "Brown",:type => "Doctor", :email => 'jbrown2@example.com', :user_id => 124563, :phone_1 => '223-232-2323', :phone_2 => '567-567-5675'},
        ...
        {:first_name => 'Kate', :last_name => "Hudson", :type => "User", :email => 'khudson555@example.com', :user_id => 111234, :phone_1 => '555-678-3467'}
